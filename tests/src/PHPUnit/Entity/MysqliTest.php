...
# Rollback, table yaoi_tests_entity_session (Yaoi\Database\Tests\Helper\Entity\Session) is already non-existent
# Rollback, table yaoi_tests_entity_host (Yaoi\Database\Tests\Helper\Entity\Host) is already non-existent
# Rollback, table yaoi_tests_entity_tag (Yaoi\Database\Tests\Helper\Entity\Tag) is already non-existent
# Rollback, table yaoi_tests_entity_session_tag (Yaoi\Database\Tests\Helper\Entity\SessionTag) is already non-existent
# Apply, table yaoi_tests_entity_session (Yaoi\Database\Tests\Helper\Entity\Session) requires migration
...
# Apply, table yaoi_tests_entity_host (Yaoi\Database\Tests\Helper\Entity\Host) requires migration
...
# Apply, table yaoi_tests_entity_tag (Yaoi\Database\Tests\Helper\Entity\Tag) requires migration
...
# OK
# Apply, table yaoi_tests_entity_session_tag (Yaoi\Database\Tests\Helper\Entity\SessionTag) requires migration
...
# Apply, table yaoi_tests_entity_tag (Yaoi\Database\Tests\Helper\Entity\Tag) is up to date
ALTER TABLE `yaoi_tests_entity_session_tag`;
# OK
# Apply, table yaoi_tests_entity_session (Yaoi\Database\Tests\Helper\Entity\Session) is up to date
# Apply, table yaoi_tests_entity_host (Yaoi\Database\Tests\Helper\Entity\Host) is up to date
# Apply, table yaoi_tests_entity_tag (Yaoi\Database\Tests\Helper\Entity\Tag) is up to date
# Apply, table yaoi_tests_entity_session_tag (Yaoi\Database\Tests\Helper\Entity\SessionTag) is up to date
# Rollback, table yaoi_tests_entity_session (Yaoi\Database\Tests\Helper\Entity\Session) requires deletion
ALTER TABLE `yaoi_tests_entity_session`
...
# Rollback, table yaoi_tests_entity_session_tag (Yaoi\Database\Tests\Helper\Entity\SessionTag) requires deletion
DROP TABLE `yaoi_tests_entity_session_tag`;
# OK
DROP TABLE `yaoi_tests_entity_session`;
# OK
# Rollback, table yaoi_tests_entity_host (Yaoi\Database\Tests\Helper\Entity\Host) requires deletion
# Dependent tables found: yaoi_tests_entity_session
# Rollback, table yaoi_tests_entity_session (Yaoi\Database\Tests\Helper\Entity\Session) is already non-existent
DROP TABLE `yaoi_tests_entity_host`;
# OK
# Rollback, table yaoi_tests_entity_tag (Yaoi\Database\Tests\Helper\Entity\Tag) requires deletion
# Dependent tables found: yaoi_tests_entity_session_tag
# Rollback, table yaoi_tests_entity_session_tag (Yaoi\Database\Tests\Helper\Entity\SessionTag) is already non-existent
